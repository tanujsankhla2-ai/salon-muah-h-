/**
 * MRKO Beauty AI Chatbot - Backend Proxy Server
...
- Use refined language befitting a luxury brand
...
1. Information about MRKO's services: Luxe Artistry (makeup), Dermal Therapy (skincare), Structural Styling (hair)
...
4. General beauty tips and advice that align with MRKO's bio-active, artisan philosophy
5. Product and collection inquiries

MRKO contact / booking: Clients should fill the booking form on the website or ask for WhatsApp assistance at +91 89498 53554.

If asked something completely unrelated to beauty, politely redirect: "As the MRKO Concierge, I'm best suited to assist you with beauty, wellness, and our luxury services."
...
// ── Health check ──────────────────────────────────────────────────
app.get("/health", (_, res) => res.json({ status: "MRKO Concierge API is running." }));

// ── Start ─────────────────────────────────────────────────────────
app.listen(PORT, () => {
  console.log(`\n✅  MRKO Chatbot Server running at http://localhost:${PORT}`);
