document.addEventListener("DOMContentLoaded", () => {
    ...
    if (bookingForm) {
        bookingForm.addEventListener('submit', (e) => {
            ...
            const message = `Hello Salon Muah! I'd like to book an elite session:%0A%0A*Name:* ${name}%0A*Elite ID / Phone:* ${phone}%0A*Session:* ${service}%0A*Date:* ${date}%0A*Time:* ${time}`;
            ...
            if (serviceBanner) serviceBanner.style.display = 'none';
            alert('Redirecting to secure your Salon Muah session!');
        });
    }
