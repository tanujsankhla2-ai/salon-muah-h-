/**
 * Salon Muah AI Chatbot Widget — js/chatbot.js
 * ─────────────────────────────────────────────
...
(() => {
    ...
    const SYSTEM_PROMPT = `You are "Salon Muah Concierge", a polished and sophisticated AI beauty assistant for Salon Muah — a premium luxury beauty salon and cosmetics brand.
...
- **Modern Signature** — $349 (Artisan Styling, Bio-Resurfacing, Collection Artistry, Salon Muah Gift) ⭐ Most popular
...
For unrelated questions, politely redirect: "As the Salon Muah Concierge, I'm best equipped to assist with beauty, wellness, and our luxury services."`;
    ...
    function buildWidget() {
        ...
        wrapper.setAttribute('aria-label', 'Salon Muah AI Chat Concierge');

        wrapper.innerHTML = `
            <!-- Toggle Bubble -->
            <button
                id="mrko-chat-toggle"
                aria-label="Open Salon Muah chat"
                aria-expanded="false"
                aria-controls="mrko-chat-window"
                title="Chat with Salon Muah Concierge"
            >
            ...
            <div
                ...
                role="dialog"
                aria-modal="true"
                aria-label="Salon Muah AI Chatbot"
                aria-hidden="true"
            >
                <!-- Header -->
                <div class="chat-header">
                    ...
                    <div class="chat-header-info">
                        <div class="chat-header-name">Salon Muah Concierge</div>
                ...
                <div class="chat-input-area">
                    <div class="chat-input-row">
                        <textarea
                            id="mrko-chat-input"
                            placeholder="Ask Salon Muah Concierge anything…"
                            rows="1"
                            maxlength="500"
                    ...
                    <p class="chat-footer-note" aria-hidden="true">✦ Powered by Salon Muah AI &bull; Gemini 2.0 Flash</p>
                </div>
            </div>
        `;
    ...
    function showTyping() {
        ...
        div.setAttribute('aria-label', 'Salon Muah Concierge is typing');
        div.innerHTML = `
            <div class="msg-avatar bot-avatar" aria-hidden="true"><i class="fas fa-spa"></i></div>
    ...
    async function sendMessage(text) {
        ...
        try {
            ...
            console.error('[Salon Muah Chatbot]', err);
        } finally {
            isTyping = false;
    ...
    function wireEvents() {
        ...
        if (waBtn) {
            waBtn.addEventListener('click', () => {
                window.open(`https://wa.me/${WHATSAPP_NUMBER}?text=Hello%20Salon%20Muah!%20I%27d%20like%20to%20inquire%20about%20a%20session.`, '_blank');
            });
        }
